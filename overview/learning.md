...
- **[python-blender-addon-agent-skill]** **Estrategia Paramétrica No Destructiva (Quad-first + Modificadores)**: Privilegiar topologías limpias basadas en quads con aristas ponderadas y modificadores no destructivos (subdivisión), garantizando que el modelo sea editable, escalable y ligero en cualquier versión del software.
