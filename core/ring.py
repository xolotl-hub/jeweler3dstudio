...
Provides:
  ...
  - Operators J3D_OT_create_ring_size and J3D_OT_create_ring_profile
...
class J3D_OT_create_ring_profile(Operator, AddObjectHelper):
    """Crea aro 3D completo con perfil parametrico y subdivision con crease"""
    bl_idname = "j3d.create_ring_profile"
